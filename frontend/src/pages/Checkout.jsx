...
export const Checkout = () => {
  ...
  return (
    <div className="container" style={{ padding: '2rem 1rem 4rem' }}>
      ...
      {showPaymentModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'var(--color-primary-30)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div className="card animate-pop-in" style={{ padding: '2.5rem 2rem', width: '90%', maxWidth: '400px', textAlign: 'center', backgroundColor: 'var(--color-surface)' }}>
            {paymentStep === 1 && (
              <>
                {paymentMethod === 'UPI' ? (
                  <>
