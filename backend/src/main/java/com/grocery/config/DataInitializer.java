...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Fruits & Veg
        products.add(Product.builder().category(catFV).name("Fresh Farm Tomatoes (Hybrid)").description("Locally sourced ripe, firm tomatoes rich in vitamins.").price(BigDecimal.valueOf(38.00)).stock(120).unit("1 kg").imageUrl("https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(15)).rating(BigDecimal.valueOf(4.8)).active(true).build());
        products.add(Product.builder().category(catFV).name("Fresh Red Onions").description("Crisp, pungent onions perfect for everyday curries and salads.").price(BigDecimal.valueOf(42.00)).stock(150).unit("1 kg").imageUrl("https://images.unsplash.com/photo-1508747703725-719777637510?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(10)).rating(BigDecimal.valueOf(4.6)).active(true).build());
        products.add(Product.builder().category(catFV).name("Baby Potatoes (Dum Aloo)").description("Freshly harvested small potatoes ideal for roasting and curries.").price(BigDecimal.valueOf(32.00)).stock(95).unit("1 kg").imageUrl("https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.5)).active(true).build());
        products.add(Product.builder().category(catFV).name("Robusta Bananas (Chitradurga Fresh)").description("Naturally ripened golden yellow sweet bananas.").price(BigDecimal.valueOf(48.00)).stock(80).unit("1 kg (5-6 pcs)").imageUrl("https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(12)).rating(BigDecimal.valueOf(4.9)).active(true).build());
        products.add(Product.builder().category(catFV).name("Shimla Royal Apple").description("Crisp, juicy and fragrant mountain apples from Himachal.").price(BigDecimal.valueOf(160.00)).stock(50).unit("4 pcs (approx 650g)").imageUrl("https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(10)).rating(BigDecimal.valueOf(4.7)).active(true).build());
        products.add(Product.builder().category(catFV).name("Fresh Coriander Leaves & Mint Bunch").description("Aromatic fresh kitchen herbs delivered chilled.").price(BigDecimal.valueOf(25.00)).stock(60).unit("1 combo pack").imageUrl("https://images.unsplash.com/photo-1608686207856-001b95cf60ca?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.4)).active(true).build());

        // Dairy & Eggs
        products.add(Product.builder().category(catDairy).name("Nandini Full Cream Milk (Special)").description("Fresh pasteurized standardized milk with 4.5% fat from KMF dairy.").price(BigDecimal.valueOf(28.00)).stock(200).unit("500 ml").imageUrl("https://images.unsplash.com/photo-1550583724-b2692b85b150?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.9)).active(true).build());
        products.add(Product.builder().category(catDairy).name("Amul Pasteurised Salted Butter").description("Delicious creamy butter made from pure milk fat.").price(BigDecimal.valueOf(56.00)).stock(110).unit("100 g").imageUrl("https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(5)).rating(BigDecimal.valueOf(4.8)).active(true).build());
        products.add(Product.builder().category(catDairy).name("Fresh Malai Paneer Cubes").description("Super soft and melt-in-mouth cottage cheese blocks.").price(BigDecimal.valueOf(95.00)).stock(65).unit("200 g").imageUrl("https://images.unsplash.com/photo-1567337710282-00832b415979?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(8)).rating(BigDecimal.valueOf(4.7)).active(true).build());
        products.add(Product.builder().category(catDairy).name("Farm Fresh Brown Eggs (High Protein)").description("Nutrient rich free range brown eggs with golden yolk.").price(BigDecimal.valueOf(85.00)).stock(90).unit("6 pcs pack").imageUrl("https://images.unsplash.com/photo-1506976785307-8732e854ad03?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(10)).rating(BigDecimal.valueOf(4.8)).active(true).build());
        products.add(Product.builder().category(catDairy).name("Mother Dairy Classic Curd / Dahi").description("Thick, rich and creamy homemade-style probiotic curd.").price(BigDecimal.valueOf(35.00)).stock(80).unit("400 g").imageUrl("https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.6)).active(true).build());

        // Staples (Atta, Rice, Dal)
        products.add(Product.builder().category(catStaples).name("Aashirvaad Shudh Chakki Atta").description("100% pure whole wheat flour processed with traditional stone chakki.").price(BigDecimal.valueOf(245.00)).stock(75).unit("5 kg").imageUrl("https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(12)).rating(BigDecimal.valueOf(4.8)).active(true).build());
        products.add(Product.builder().category(catStaples).name("Namma Premium Sona Masoori Raw Rice").description("Aged fragrant polished grain rice ideal for South Indian meals.").price(BigDecimal.valueOf(340.00)).stock(60).unit("5 kg bag").imageUrl("https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(15)).rating(BigDecimal.valueOf(4.7)).active(true).build());
        products.add(Product.builder().category(catStaples).name("Tata Sampann Unpolished Toor Dal").description("Rich in dietary protein without artificial chemical polish.").price(BigDecimal.valueOf(175.00)).stock(85).unit("1 kg").imageUrl("https://images.unsplash.com/photo-1599940824399-b87987ceb72a?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(10)).rating(BigDecimal.valueOf(4.9)).active(true).build());
        products.add(Product.builder().category(catStaples).name("Fortune Sunlite Refined Sunflower Oil").description("Enriched with vitamins A & D for healthy heart cooking.").price(BigDecimal.valueOf(135.00)).stock(95).unit("1 L pouch").imageUrl("https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(8)).rating(BigDecimal.valueOf(4.6)).active(true).build());
        products.add(Product.builder().category(catStaples).name("Tata Salt Iodized Crystal Purity").description("Desh ka namak with vacuum evaporated purity.").price(BigDecimal.valueOf(28.00)).stock(150).unit("1 kg").imageUrl("https://images.unsplash.com/photo-1518110925495-5fe2fda0442c?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.9)).active(true).build());

        // Snacks & Munchies
        products.add(Product.builder().category(catSnacks).name("Lay's India's Magic Masala Chips").description("Crispy spiced potato chips seasoned with authentic Indian herbs.").price(BigDecimal.valueOf(20.00)).stock(180).unit("50 g pack").imageUrl("https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.7)).active(true).build());
        products.add(Product.builder().category(catSnacks).name("Haldiram's Bhujia Sev Special").description("Classic spicy moth bean and besan noodle snack.").price(BigDecimal.valueOf(65.00)).stock(100).unit("200 g").imageUrl("https://images.unsplash.com/photo-1621996346565-e3d5d62810b7?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(5)).rating(BigDecimal.valueOf(4.6)).active(true).build());
        products.add(Product.builder().category(catSnacks).name("Happilo California Roasted Almonds").description("Crunchy lightly salted California whole almonds.").price(BigDecimal.valueOf(299.00)).stock(40).unit("200 g pouch").imageUrl("https://images.unsplash.com/photo-1508061252966-f72fb9822365?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(20)).rating(BigDecimal.valueOf(4.9)).active(true).build());
        products.add(Product.builder().category(catSnacks).name("Kurkure Masala Munch Crunchy").description("Chatpata crunchy corn puff namkeen snack.").price(BigDecimal.valueOf(20.00)).stock(140).unit("75 g").imageUrl("https://images.unsplash.com/photo-1599490659213-e2b9527bd087?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.5)).active(true).build());

        // Cold Drinks & Juices
        products.add(Product.builder().category(catDrinks).name("Raw Pressery Tender Coconut Water").description("100% pure tender coconut water with naturally balanced electrolytes.").price(BigDecimal.valueOf(60.00)).stock(90).unit("200 ml bottle").imageUrl("https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(10)).rating(BigDecimal.valueOf(4.8)).active(true).build());
        products.add(Product.builder().category(catDrinks).name("Real Activ 100% Orange Juice").description("No added sugar, pure Valencia orange juice rich in vitamin C.").price(BigDecimal.valueOf(130.00)).stock(70).unit("1 L tetra pack").imageUrl("https://images.unsplash.com/photo-1613478223719-2ab802602423?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.valueOf(15)).rating(BigDecimal.valueOf(4.6)).active(true).build());
        products.add(Product.builder().category(catDrinks).name("Thums Up Charged Carbonated Beverage").description("Taste the thunder with bold fizzy cola kick.").price(BigDecimal.valueOf(40.00)).stock(120).unit("750 ml pet bottle").imageUrl("https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=600&auto=format&fit=crop&q=80").discount(BigDecimal.ZERO).rating(BigDecimal.valueOf(4.7)).active(true).build());
